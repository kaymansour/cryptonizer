...
async def compare_strategies_endpoint(request: StrategyComparisonRequest):
    ...
    try:
        ...
        if request.include_benchmarks is None:
            request.include_benchmarks = ['equal_weight', 'btc_only', 'eth_only', 'btc_eth_60_40']
...
async def quick_backtest_endpoint(symbols: List[str], weights: Dict[str, float], days_back: int = 365):
    """
